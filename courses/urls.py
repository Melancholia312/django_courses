...
from .views import CourseDetail, CourseList, Index, CourseFilter, CourseSearch, CourseSignUp, UserCoursesView

urlpatterns = [
    path('', Index.as_view(), name='home'),
    path('my_courses/', UserCoursesView.as_view(), name='user_courses_view'),
